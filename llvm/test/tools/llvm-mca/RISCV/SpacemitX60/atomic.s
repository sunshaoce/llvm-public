...
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_W                  amoswap.w	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_W                   amoadd.w	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_W                   amoxor.w	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_W                   amoand.w	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_W                    amoor.w	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_W                   amomin.w	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_W                   amomax.w	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_W                  amominu.w	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_W                  amomaxu.w	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_W_AQ               amoswap.w.aq	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_W_AQ                amoadd.w.aq	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_W_AQ                amoxor.w.aq	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_W_AQ                amoand.w.aq	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_W_AQ                 amoor.w.aq	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_W_AQ                amomin.w.aq	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_W_AQ                amomax.w.aq	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_W_AQ               amominu.w.aq	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_W_AQ               amomaxu.w.aq	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_W_RL               amoswap.w.rl	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_W_RL                amoadd.w.rl	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_W_RL                amoxor.w.rl	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_W_RL                amoand.w.rl	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_W_RL                 amoor.w.rl	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_W_RL                amomin.w.rl	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_W_RL                amomax.w.rl	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_W_RL               amominu.w.rl	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_W_RL               amomaxu.w.rl	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_W_AQRL             amoswap.w.aqrl	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_W_AQRL              amoadd.w.aqrl	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_W_AQRL              amoxor.w.aqrl	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_W_AQRL              amoand.w.aqrl	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_W_AQRL               amoor.w.aqrl	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_W_AQRL              amomin.w.aqrl	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_W_AQRL              amomax.w.aqrl	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_W_AQRL             amominu.w.aqrl	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_W_AQRL             amomaxu.w.aqrl	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_D                  amoswap.d	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_D                   amoadd.d	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_D                   amoxor.d	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_D                   amoand.d	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_D                    amoor.d	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_D                   amomin.d	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_D                   amomax.d	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_D                  amominu.d	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_D                  amomaxu.d	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_D_AQ               amoswap.d.aq	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_D_AQ                amoadd.d.aq	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_D_AQ                amoxor.d.aq	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_D_AQ                amoand.d.aq	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_D_AQ                 amoor.d.aq	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_D_AQ                amomin.d.aq	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_D_AQ                amomax.d.aq	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_D_AQ               amominu.d.aq	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_D_AQ               amomaxu.d.aq	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_D_RL               amoswap.d.rl	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_D_RL                amoadd.d.rl	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_D_RL                amoxor.d.rl	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_D_RL                amoand.d.rl	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_D_RL                 amoor.d.rl	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_D_RL                amomin.d.rl	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_D_RL                amomax.d.rl	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_D_RL               amominu.d.rl	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_D_RL               amomaxu.d.rl	s5, s4, (s3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOSWAP_D_AQRL             amoswap.d.aqrl	a4, ra, (s0)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOADD_D_AQRL              amoadd.d.aqrl	a1, a2, (a3)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOXOR_D_AQRL              amoxor.d.aqrl	a2, a3, (a4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOAND_D_AQRL              amoand.d.aqrl	a3, a4, (a5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOOR_D_AQRL               amoor.d.aqrl	a4, a5, (a6)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMIN_D_AQRL              amomin.d.aqrl	a5, a6, (a7)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAX_D_AQRL              amomax.d.aqrl	s7, s6, (s5)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMINU_D_AQRL             amominu.d.aqrl	s6, s5, (s4)
# CHECK-NEXT:  1      13    0.50    *      *             13    SMX60_LS                                   AMOMAXU_D_AQRL             amomaxu.d.aqrl	s5, s4, (s3)
